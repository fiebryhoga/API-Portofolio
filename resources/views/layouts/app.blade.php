    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="{{ url('/blogContents') }}">Blog Contents</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('/projects') }}">Projects</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('/projectTags') }}">Project Tags</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('/references') }}">References</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ url('/referenceContents') }}">Reference Contents</a></li>
